<template>
    <div>
        ...
        <b-modal ref="modalAcrosticoMagico" hide-footer title="Acróstico">
            <div class="d-block text-center">
                <b-form-input
        ...
        <b-modal ref="modalYElEmoticon" hide-footer title="ABC de Emojis">
            <div class="d-block text-center">
                <b-form-input
        ...
        <b-modal ref="modalDinamicaAhorcados" hide-footer title="Ahorcados">
            <div class="d-block text-center">
                <b-container>
                    <b-row>
                        <b-col cols="8">
        ...
        <b-modal ref="modalEscaleraMagica" hide-footer title="Escaleras">
            <div class="d-block text-center">
                <b-form-radio-group
                class="pt-2"
                :options="['Componer', 'Descomponer']"
                v-model="escaleraMagica.tipoEntrada"
                ></b-form-radio-group>
                <b-form-input
        ...
        <b-modal ref="modalEncorazonados" hide-footer title="Encorazonados">
            <div class="d-block text-center">
                <b-form-input
                    id="emojiEncora"
                    v-model="encora.emoji"
                    placeholder="Emoji"
                    autocomplete="off"
                ></b-form-input>
                <b-form-input
...
export default {
    ...
    data () {
    return {
        title: 'Truqueros Unidos',
        tema: 'Dinámicas disponibles',
        selected: 'first',
        acrosticoCruzado:{
            entradaTexto:'',
  ...
  methods:{
      ...
      /*48 emojis 21 de Agosto del 2019*/
      realizarYElEmoticon(){
      ...
      realizarEscaleraMagica(){
          ...
          while(entrada.length > 0){
              ...
              aux[i] = entrada;
              if(entrada.charAt(entrada.length-2)=== ' ' || entrada.charAt(entrada.length)=== '�'){
          ...
          if (this.escaleraMagica.tipoEntrada == 'Componer') {
                this.escaleraMagicaHTML = ""
                aux = aux.reverse();
                for (var j = 0; j < aux.length; j++) {
                    this.escaleraMagicaHTML= this.escaleraMagicaHTML + aux[j] + '\n';
                }
          }
      },
      realizarParsel(){
